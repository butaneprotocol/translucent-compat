import { Constr, Data } from "../src/mod.ts";
import {assert, assertEquals} from "./util.ts"

describe("Roundtrip data bigint", () => {
  /*
    - TypeScript:
...
describe("Roundtrip data string", () => {
  /*
    - TypeScript:
...
describe("Roundtrip data boolean", () => {
  /*
    - TypeScript:
...
describe("Roundtrip data object", () => {
  /*
    - TypeScript:
...
describe("Roundtrip data enum with named args", () => {
  /*
    - TypeScript:
